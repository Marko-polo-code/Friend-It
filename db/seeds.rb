...
PERKS = ["Wifi", "Air conditioning", "Hair dryer", "TV", "Private Bathroom", "Pool", "Free Parking", "Pet-friendly", "Boating", "Dishwasher", "En suite bathroom", "Fridge", "Golf", "Fridge", "Ironing", "Shower", "Bathtub"]
...
10.times do
  ...
  3.times do
    FlatPerk.create(flat: flat, perk: Perk.all.sample)
  end
end
...
10.times do
  recommendation = Recommendation.new(
   ...
   address: ADDRESSES.sample,
   description: "Some other really cool description",
   flat: Flat.all.sample
  )
  recommendation.save!
end
...
10.times do
  swap_request = SwapRequest.new(
    ...
    end_date: Date.today + rand(15..20),
    status: ["pending", "accepted", "rejected"].sample,
    requester_flat: Flat.all.sample,
    requested_flat: Flat.all.sample
  )
  swap_request.save!
end
puts 'Finished!'
